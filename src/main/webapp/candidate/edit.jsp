...
<div class="container pt-3">
    <div class="row">
        <div class="card" style="width: 100%">
            ...
            <div class="card-body">
                <form action="<%=request.getContextPath()%>/candidates.do?id=<%=cnd.getId()%>" method="post">
                    <div class="form-group">
                        <label for="name">Имя</label>
                        <input type="text" class="form-control" id="name" name="name" value="<%=cnd.getName()%>">
                    </div>
